...
5. Once poetry has install all packages in the same directory, navigate to the Supervised_Learning folder and run 'poetry run python run-experiments.py' to run all the machine learning models
