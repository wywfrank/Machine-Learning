...
class NeuralNetwork(BaseClassifier):
    ...
    def __init__(self, alpha=0.0001, layer1_nodes=50, layer2_nodes=30, learning_rate=0.001, max_iter=200):
        ...
        self.model = Pipeline([('scaler', StandardScaler()),
                               ('nn', MLPClassifier(hidden_layer_sizes=(layer1_nodes), activation='relu',
                                                    solver='sgd', alpha=alpha, batch_size=200, learning_rate='invscaling',
        ...
        self.default_params = {'nn__hidden_layer_sizes': (layer1_nodes, layer2_nodes),
    ...
    def plot_model_complexity(self, x_train, y_train, **kwargs):
        ...
        best_learning_rate, score = super().plot_model_complexity(x_train, y_train, **kwargs)
        ...
        # Create a new figure for the hidden layers term validation curve 
        # plt.figure()
        # kwargs['param'] = 'nn__hidden_layer_sizes'
        # kwargs['param_range'] = kwargs['first_hidden_layer_sizes_range']
        # kwargs['x_label'] = 'Size of first hidden layer'
        # best_hidden_layer_sizes, score = super().plot_model_complexity(x_train, y_train, **kwargs)
        # print('--> best_hidden_layer_sizes = {} --> score = {:.4f}'.format(best_hidden_layer_sizes, score))

        # # Save the optimal regularization term in our dictionary of optimal parameters and save figure
        # self.optimal_params['nn__hidden_layer_sizes'] = best_hidden_layer_sizes
        # plt.savefig(IMAGE_DIR + '{}_first_hidden_layer_sizes'.format(self.name))
        ...
        plt.figure()
        # kwargs['param'] = 'nn__hidden_layer_sizes'
        # kwargs['param_range'] = kwargs['second_hidden_layer_sizes_range']
        # kwargs['x_label'] = 'Size of second hidden layer'
        ...
        # # Save the optimal regularization term in our dictionary of optimal parameters and save figure
        # self.optimal_params['nn__hidden_layer_sizes'] = best_hidden_layer_sizes
        # plt.savefig(IMAGE_DIR + '{}_second_hidden_layer_sizes'.format(self.name))
    ...
    def plot_learning_curve(self, x_train, y_train, **kwargs):
        ...
        super().plot_learning_curve(x_train, y_train, **kwargs)
        ...
        train_scores, test_scores = [], []  # list of training and validation scores
        ...
        for train_fold, test_fold in StratifiedKFold(n_splits=kwargs['cv']).split(x_train, y_train):

            # Training and validation set for current fold
            x_train_fold, x_test_fold = x_train[train_fold], x_train[test_fold]
            y_train_fold, y_test_split = y_train[train_fold], y_train[test_fold]

            # List of training and validation scores for current fold
            train_scores_fold, test_scores_fold = [], []
            ...
            for _ in epochs:
                ...
                test_scores_fold.append(model.score(x_test_fold, y_test_split))
        ...
        self._plot_helper_(epochs, train_scores.T, test_scores.T, train_label='Training', test_label='Cross-Validation')
