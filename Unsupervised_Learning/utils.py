...
def plot_clusters(ax, component1, component2, df, name):
    ...
    sns.scatterplot(x=component1, y=component2, hue='y', data=df, legend='full', alpha=0.3, ax=ax[0])
    sns.scatterplot(x=component1, y=component2, hue='c', data=df, legend='full', alpha=0.3, ax=ax[1])
...
def plot_components(component1, component2, df, name):
    ...
    sns.scatterplot(x=component1, y=component2, hue='y', data=df, legend='full', alpha=0.3)
